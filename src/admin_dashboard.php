...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <a class="nav-link  px-3 active" href="admin_dashboard.php">Dashboard</a>
                            <a class="nav-link  px-3" aria-current="page" href="admin_users.php">Users</a>
    ...
    <div class="container">
        ...
        <div id="flip2" class="mt-2">
            <h1 class="mb-2">RECENT BLOGS:</h1>
        </div>
        <div id="panel2">
            <?php display_dashboard_blog(); ?>
        </div>
    </div>
