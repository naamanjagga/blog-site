                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link px-3" href="blog.php">Feed</a>
                            <a class="nav-link px-3" href="myblog.php">My Blogs</a>
                            <a class="nav-link active px-3" aria-current="page" href="writeblog.php">Write Blog</a>
                        </div>
                    </div>
    ...
    <div class="container mt-5 pt-5">
        <form action="backend.php" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea type="number" name="blog_content" class="form-control"></textarea>
            </div><br>
            <div>
                <button name="blog" class="btn btn-primary">
                    Add Blog
                </button>
            </div>
        </form>
